package Crypto.main.src.cipher;
...
public class ROT13  {
    ...
    public String caesar(String stringToEncrypt) {
        shift = 3;
        return crypt(stringToEncrypt);
    }

    public void encrypt(String text) throws FileNotFoundException, UnsupportedOperationException{
    }
